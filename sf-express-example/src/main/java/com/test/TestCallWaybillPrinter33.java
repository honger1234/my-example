...
public class TestCallWaybillPrinter33 {
    ...
    public static void WayBillPrinterTools() throws Exception {
         ...
         */
        String url7 = "http://172.16.150.246:4040/sf/waybill/print?type=V2.0.FM_poster_100mm150mm&output=noAlertPrint";
        /**
        ...
        // 这个必填
        dto.setAppId("ZT_4Xp1i");// 对应clientCode
        dto.setAppKey("nomAJwdcIj5L53BOny6vrE1r4nxyQMkv");// 对应checkWord
        ...
        dto.setReturnTrackingRemark("签回单备注");
